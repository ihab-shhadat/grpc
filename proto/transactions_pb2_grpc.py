...
from proto import transactions_pb2 as transactions__pb2
...
class TransactionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTransaction = channel.unary_unary(
                ...
                request_serializer=transactions__pb2.Query.SerializeToString,
...
def add_TransactionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetTransaction': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=transactions__pb2.Query.FromString,
...
class TransactionService(object):
    ...
    def GetTransaction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TransactionService/GetTransaction',
            transactions__pb2.Query.SerializeToString,
